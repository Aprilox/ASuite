        ...
        {toolKeys.map((tool) => {
          ...
          return (
            <Link
              ...
              className={`group relative p-6 rounded-xl border bg-card hover:shadow-lg transition-all duration-300 ${!isActive ? 'opacity-60 cursor-not-allowed' : 'hover:-translate-y-1'
                }`}
